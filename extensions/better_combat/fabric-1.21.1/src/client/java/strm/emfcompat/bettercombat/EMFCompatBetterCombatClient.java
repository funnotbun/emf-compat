...
public class EMFCompatBetterCombatClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        spellEnginePresent = FabricLoader.getInstance().isModLoaded(SPELL_ENGINE_ID);
        ...
        // NeoForge defers this to enqueueWork off the mod-event bus; a Fabric client initializer
        // already runs at the right moment, so it goes straight in.
        try {
