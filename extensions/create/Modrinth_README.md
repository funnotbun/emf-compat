...
- Jetpack flight (Cosmonautics and Create S&A) can play only with **[Fresh Animations: Player Extension](https://modrinth.com/resourcepack/fa-player-extension)**).
...
- **Forge 1.20.1** — Skyhook, hats, Create Stuff 'N Additions and the Not Enough Animations fix.
